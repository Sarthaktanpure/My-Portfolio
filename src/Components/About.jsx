...
const PROFILE_IMAGE_URL =
  "https://placehold.co/800x1200/18181b/ffffff?text=SARTHAK+TANPURE";

// --- Social Links Data ---
const socialLinks = [
  {
    icon: Github,
    href: "https://github.com/Sarthaktanpure",
    name: "GitHub",
  ...
  {
    icon: Linkedin,
    href: "https://www.linkedin.com/in/sarthak-tanpure-a74b5133a?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    name: "LinkedIn",
  ...
  {
    icon: Instagram,
    href: "https://www.instagram.com/sarthak_tanpure_9290",
    name: "Instagram",
  ...
  {
    icon: Mail,
    href: "mailto:sarthaktanpure255@gmail.com",
    name: "Email",
    ...
    {socialLinks.map((link, index) => {
      ...
      return (
        ...
        >
          ...
          <div
            className="absolute top-6 left-1/2 w-0.5 h-20 bg-gray-700 -translate-x-1/2 transform-gpu" // Increased thread height from h-16 to h-20 for a longer drop
            style={{ transformOrigin: "top center" }}
          >
    ...
    >
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 py-10">
        ...
        <p className="text-gray-400 mt-6 text-base leading-relaxed max-w-xl">
          Hi! I’m **Sarthak Tanpure**, an enthusiastic IT engineering student
          and a passionate software developer who loves turning ideas into
          impactful digital experiences. I enjoy exploring the world of web
          development, AI, and programming, and I’m constantly learning new
          technologies to improve my skills and creativity. I’ve worked with
          languages like C, C++, Java, and Python, and I’m currently focusing on
          full-stack web development using tools like **React, Node.js, and
          databases**. I also have a strong interest in AI/ML and aspire to
          build intelligent solutions that make a real-world difference. When
          I’m not coding, you’ll probably find me exploring new tech trends,
          working on side projects, or brainstorming innovative ideas to solve
          community problems through technology.
        </p>
